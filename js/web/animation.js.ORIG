...
//
Reflect.defineProperty(Node.prototype, 'finishTextContent', { value: function()
{
	if(!this._setTextContent || !this._setTextContent.lines)
	{
	...
	if(typeof this._setTextContent.animation === 'number')
	{
